...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column="selected", property="selected", jdbcType=JdbcType.VARCHAR)
    })
...
@Select({
        ...
        "selected",
        "from user",
        "where id = #{account,jdbcType=VARCHAR}"
})

    String selectMineCourse(@Param("account") String account);
}